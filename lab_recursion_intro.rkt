...
(define (map f lst)
  (if (null? lst) '() (append (list(f (car lst))) (map f (cdr lst)))))
...
(define (filter pred lst)
  (if (null? lst) '() (if (pred (car lst)) (append (list(car lst)) (filter pred (cdr lst))) (filter pred (cdr lst)))))
