...
(define (union LA LB)
  (cond [(null? (make-set LA)) (make-set LB)]
        [(null? (make-set LB)) (make-set LA)]
        [(element? (car (make-set LA)) (make-set LB)) (union (cdr (make-set LA)) (make-set LB))]
        [else (cons (car LA) (union (cdr (make-set LA)) (make-set LB)))]))
...
(define (intersection LA LB)
  (cond [(null? LA) '()]
        [(null? LB) '()]
        [(element? (car (make-set LA)) (make-set LB)) (cons (car (make-set LA)) (intersection (cdr (make-set LA)) (make-set LB)))]
        [else (intersection (cdr (make-set LA)) (make-set LB))]))
...
(define (set-equal? SA SB)
  (cond [(and (null? SA)(null? SB)) #t]
        [(or (> (length (make-set SA)) (length (make-set SB))) (> (length (make-set SB)) (length (make-set SA)))) #f]
        [(subset? (make-set SA)(make-set SB)) #t]
        [else #f]))
...
(define (set-difference LA LB)
  (cond [(null? LA) '()]
        [(null? LB) (make-set LA)]
        [(element? (car (make-set LA)) (make-set LB)) (set-difference (cdr (make-set LA)) (make-set LB))]
        [else (cons (car (make-set LA)) (set-difference (cdr (make-set LA)) (make-set LB)))]))
...
(define (sym-diff LA LB)
  (make-set(union (set-difference LA LB) (set-difference LB LA))))
